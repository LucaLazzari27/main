...
def plan_results_to_fixedcap_override(results, filename='generic'):
    ...
    yaml.width=1000
    with open(r'C:\Users\Hewlett-Packard\Desktop\Calliope Italy Model Francesco Lombardi\Calliope-NL-main\model_files\fixed-design-cost-optimal.yaml', 'w') as outfile:
        yaml.dump(override_dict, outfile)
        
    with open(r"C:\Users\Hewlett-Packard\Desktop\Calliope Italy Model Francesco Lombardi\Calliope-NL-main\model_files\fixed-design-cost-optimal.yaml", "r+") as f:
        contents = f.read()
        f.seek(0)
